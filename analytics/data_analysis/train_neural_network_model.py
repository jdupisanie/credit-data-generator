...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train a neural network classifier on the training dataset."
    )
    parser.add_argument(
        "--train",
        type=Path,
...
def main() -> None:
    ...
    model = MLPClassifier(
        hidden_layer_sizes=hidden_layers if hidden_layers else (64, 32),
        activation="relu",
        solver="adam",
        alpha=1e-4,
